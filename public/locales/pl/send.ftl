...
sendYourFilesLink = Wypróbuj Miku Send
...
notSupportedOutdatedDetail = Ta wersja Firefoksa nie obsługuje technologii internetowej, która napędza Miku Send. Należy uaktualnić przeglądarkę.
...
javascriptRequired = Miku Send wymaga języka JavaScript
whyJavascript = Dlaczego Miku Send wymaga języka JavaScript?
