...
sendYourFilesLink = Garahuè dàj 'iaj sun Miku Send
...
notSupportedOutdatedDetail = Nu unùkuaj Firefox nan gi'iaj sunj ngà sa 'iaj sun ngà Miku Send. Da'uît nāgi'iaj nakàt riña sa nana'uî't han.
...
javascriptRequired = Ni'ñānj Miku Send JavaScript
whyJavascript = Nù huin saj ni'ñānj Miku Send JavaScript rà'aj?
