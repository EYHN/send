...
sendYourFilesLink = Chak'amb'ejaj Miku Send
...
notSupportedOutdatedDetail = Chakuyu' we okib'al rech Firefox man kutoq'aj ta le k'ak'eta'm rech web' le kuya' uchuq'ab' Miku Send. Rajawaxik kak'ak'arisaj le anik'onel.
...
javascriptRequired = Le Miku Send kajawataj JavaScript chech
whyJavascript = ¿jasche kajawataj JavaScript chech  Miku Send?
