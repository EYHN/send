...
notSupportedOutdatedDetail = Ọ dị nwute na ụdị Firefox a anaghị akwado teknụzụ weebụ na-eji Miku Zipụ. Ikwesiri imelite ihe nchọgharị gị.
updateFirefox = Melite Firefox
deletePopupCancel = Kagbuo
deleteButtonHover = Hichapụ
whyJavascript = Kedu ihe kpatara Miku Send jiri chọ JavaScript?
