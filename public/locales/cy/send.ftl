...
sendYourFilesLink = Rhowch gynnig ar Miku Send
...
notSupportedOutdatedDetail = Yn anffodus, nid yw'r fersiwn yma o Firefox yn cynnal y technoleg gwe sy'n gyrru Miku Send. Bydd angen i chi ddiweddaru eich porwr.
...
javascriptRequired = Mae Miku Send angen JavaScript
whyJavascript = Pam fod Miku Send angen JavaScript?
