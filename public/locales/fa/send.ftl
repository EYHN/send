...
sendYourFilesLink = Miku Send را امتحان کنید
...
notSupportedOutdatedDetail = متاسفانه این نسخه از فایرفاکس این تکنولوژی وب که به Miku Send قدرت می‌بخشد را پشتیبانی نمی‌کند. شما نیاز دارید تا مرورگر خود را بروز کنید.
...
javascriptRequired = Miku Send نیازمند جاوااسکریپت است
whyJavascript = چرا Miku Send جاوااسکریپت لازم داد؟
