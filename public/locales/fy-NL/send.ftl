...
sendYourFilesLink = Miku Send probearje
...
notSupportedOutdatedDetail = Spitigernôch stipet dizze ferzje fan Firefox de webtechnology dy't Miku Send mooflik makket net. Jo moatte jo browser fernije.
...
javascriptRequired = Miku Send fereasket JavaScript.
whyJavascript = Werom hat Miku Send JavaScript nedich?
