...
sendYourFilesLink = Coba Miku Send
...
notSupportedOutdatedDetail = Sayangnya Firefox versi ini tidak mendukung teknologi web yang menggerakkan Miku Send. Anda perlu memperbarui peramban Anda.
...
javascriptRequired = Miku Send membutuhkan JavaScript.
whyJavascript = Mengapa Miku Send membutuhkan JavaScript?
