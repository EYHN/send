...
sendYourFilesLink = Xikejeko Miku Send
...
notSupportedOutdatedDetail = Tetayokoltij, Firefox tein tikuitok amo kiselia tepostekitilis tecnología web tein ika tekiti Miku Send. Moneki tikyankuilis monavegador.
...
javascriptRequired = Miku Send kineki maj moajsi JavaScript
whyJavascript = ¿Keyej Miku Send kineki maj moajsi JavaScript?
