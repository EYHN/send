...
sendYourFilesLink = Miku Send proberen
...
notSupportedOutdatedDetail = Helaas ondersteunt deze versie van Firefox de webtechnologie die Miku Send gebruikt niet. U dient uw browser bij te werken.
...
javascriptRequired = Miku Send vereist JavaScript
whyJavascript = Waarom vereist Miku Send JavaScript?
