...
sendYourFilesLink = Prova Miku Send
...
notSupportedOutdatedDetail = Purtroppo questa versione di Firefox non supporta le tecnologie web alla base di Miku Send. È necessario aggiornare il browser.
...
javascriptRequired = Miku Send richiede JavaScript
whyJavascript = Perché Miku Send richiede JavaScript?
