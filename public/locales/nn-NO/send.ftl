...
notSupportedOutdatedDetail = Dessverre støttar ikkje denne versjonen av Firefox nett-teknologien som driv Miku Send. Du må å oppdatere nettlesaren din.
...
javascriptRequired = Miku Send krev JavaScript.
whyJavascript = Kvifor krev Miku Send JavaScript?
