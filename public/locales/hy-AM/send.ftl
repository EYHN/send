...
sendYourFilesLink = Փորձել Miku Send-ը
...
notSupportedOutdatedDetail = Դժբախտաբար, Firefox- ի այս տարբերակը չի աջակցում այն վեբ տեխնոլոգիան, որը պետք է Miku Send-ի համար: Դուք պետք է թարմացնեք ձեր զննարկիչը:
...
javascriptRequired = Miku Send-ը պահանջում է JavaScript
whyJavascript = Ինչո՞ւ է Miku Send-ը պահանջում JavaScript.
