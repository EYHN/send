...
sendYourFilesLink = Ɛreḍ Miku Send
...
notSupportedOutdatedDetail = Ad nesḥissef imilqem-agi n Firefox Firefox ur isefrak ara titiknulujiyin web yettwaseqdacen di Miku Send. Yessefk ad tleqmeḍ iminig-ik.
...
javascriptRequired = Miku Send yesra JavaScript
whyJavascript = Ayɣer Miku Send yesra JavaScript?
