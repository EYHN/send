...
sendYourFilesLink = Vyskúšajte Miku Send
...
notSupportedOutdatedDetail = Žiaľ, táto verzia Firefoxu nepodporuje webovú technológiu, ktorá poháňa Miku Send. Budete musieť aktualizovať svoj prehliadač.
...
javascriptRequired = Miku Send vyžaduje JavaScript
whyJavascript = Prečo Miku Send vyžaduje JavaScript?
