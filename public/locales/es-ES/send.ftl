...
sendYourFilesLink = Prueba Miku Send
...
notSupportedOutdatedDetail = Lamentablemente, esta versión de Firefox no admite la tecnología web que impulsa Miku Send. Tendrás que actualizar tu navegador.
...
whyJavascript = ¿Por qué Miku Send requiere JavaScript?
