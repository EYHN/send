...
sendYourFilesLink = Testa Miku Send
...
notSupportedOutdatedDetail = Tyvärr stödjer den här versionen av Firefox inte webbtekniken som driver Miku Send. Du måste uppdatera din webbläsare.
...
javascriptRequired = Miku Send kräver JavaScript
whyJavascript = Varför kräver Miku Send JavaScript?
