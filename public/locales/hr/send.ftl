...
sendYourFilesLink = Isprobajte Miku Send
...
notSupportedOutdatedDetail = Nažalost, ovo izdanje Firefoxa ne podržava web tehnologiju koja omogućava Miku Send. Morat ćete ažurirati vaš preglednik.
