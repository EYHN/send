...
sendYourFilesLink = Miku Send Yoxla
...
notSupportedOutdatedDetail = Heyf ki, Firefox səyyahının bu versiyası Miku Send-ə güc verən web texnologiyalarını dəstəkləmir. Səyyahınızı yeniləməlisiniz.
...
javascriptRequired = Miku Send üçün JavaScript lazımdır
whyJavascript = Miku Send niyə JavaScript tələb edir?
