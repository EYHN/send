...
sendYourFilesLink = Prøv Miku Send
...
notSupportedOutdatedDetail = Dessverre støtter ikke denne versjonen av Firefox netteknologien som driver Miku Send. Du trenger å oppdatere nettleseren din.
...
javascriptRequired = Miku Send krever JavaScript.
whyJavascript = Hvorfor krever Miku Send JavaScript?
