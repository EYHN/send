...
sendYourFilesLink = Proveu el Miku Send
...
notSupportedOutdatedDetail = Aquesta versió del Firefox no admet la tecnologia web amb què funciona el Miku Send. Haureu d'actualitzar el navegador.
...
javascriptRequired = El Miku Send necessita JavaScript
whyJavascript = Per què el Miku Send necessita JavaScript?
