...
# Miku Send is a brand name and should not be localized.
downloadMessage = Vaš prijatelj vam je poslao datoteku preko usluge Miku Send koja vam omogućava da dijelite datoteke preko sigurne, privatne i šifrovane veze koja samostalno ističe da vaše stvari ne ostanu zauvijek na internetu.
...
# Miku Send is a brand name and should not be localized.
sendYourFilesLink = Probajte Miku Send
...
# Miku Send is a brand name and should not be localized.
notSupportedDetail = Ovaj pretraživač nažalost ne podržava web tehnologiju koja omogućava Miku Send. Trebate probati drugi pretraživač. Preporučujemo Firefox!
notSupportedLink = Zašto moj pretraživač nije podržan?
notSupportedOutdatedDetail = Nažalost ova verzija Firefoxa ne podržava web tehnologiju koja omogućava Miku Send. Morate ažurirati vaš pretraživač.
...
legalNoticeTestPilot = Miku Send je trenutno Test Pilot eksperiment i podržan je <a>uslovima korištenja</a> i <a>obavještenjem o privatnosti</a>. Možete saznati više o ovom eksperimentu i o njegovom sakupljanju podataka <a>ovdje</a>.
legalNoticeMozilla = Korištenje Miku Send web stranice podlaže Mozillinom <a>obavještenju o privatnosti na web stranicama</a> i <a>uslovima korištenja web stranica</a>.
...
javascriptRequired = Miku Send zahtjeva JavaScript
whyJavascript = Zašto Miku Send zahtjeva JavaScript?
