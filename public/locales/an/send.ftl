...
sendYourFilesLink = Preba Miku Send
...
notSupportedOutdatedDetail = Esta versión de Firefox no admite la tecnolochía web con que funciona lo Miku Send. Habrás d'esviellar lo navegador.
...
javascriptRequired = Miku Send necesita JavaScript
whyJavascript = Per qué Miku Send necesita JavaScript?
